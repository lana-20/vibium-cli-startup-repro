...
python3 verify_readme.py  # this README vs the repo, 34 checks
...
`EVIDENCE.md` is the block-by-block fact-check record — which blocks of this README
carry checkable assertions, what checks each, and which rest on things this
